const getAccessToken = (z, bundle) => {
  const promise = z.request(`http://nightly.nuxeo.com/nuxeo/oauth2/access-token`, {
    method: 'POST',
    body: {
      code: bundle.inputData.code,
      client_id: 'nuxeo-mobile',
...
const testAuth = (z /* , bundle*/) => {
  ...
  const promise = z.request({
    method: 'GET',
    url: `http://nbm-dev.nuxeo.io/nuxeo/json/cmis`,
  });
...
module.exports = {
  ...
  oauth2Config: {
    ...
    authorizeUrl: {
      url: `http://nbm-dev.nuxeo.io/nuxeo/oauth2/authorize`,
      params: {
        client_id: 'nuxeo-mobile',
